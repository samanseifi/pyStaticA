...
def extract_xy_data(filename):
    ...
    # TODO: Capabbility to translate or read other formats
...
def calculate_yield_point(xy_data, offset, point1, point2):
    ...
    # Finding the yield point: Intersectio of y_offset with xy_data
...
def full_analysis(card):
    ...
    # Calculate yield and correspoinding point on the xy_data
    yield_point = calculate_yield_point(xy_data, card.offset, point1, point2)

    # Calculate ultimate and correspoinding point on the xy_data
